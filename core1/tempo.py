...
class tempo():
    ...
    ############################################################################
    # Method: tempoAdjust() - Adjust tempo
    ############################################################################
    def tempoAdjust(self, adjust):
        if adjust:
            return self.tempoSetCheck(self.tempo + adjust)


    ############################################################################
    # Method: tempoMin() - Adjust tempo
    ############################################################################
    def tempoMinSet(self):
        self.tempo = self.tempoMin

    ############################################################################
    # Method: tempoMin() - Adjust tempo
    ############################################################################
    def tempoMaxSet(self):
        self.tempo = self.tempoMax
